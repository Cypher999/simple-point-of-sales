          ...
          <tbody>
            @foreach($data as $d)
                <tr>
                    ...
                    <td>
                      <div class="row">
                        <a class="m-2 col-10 col-md-5 d-block" href="{{url('gudang/barang/edit',$d->id)}}">
                          <button type="button" class="btn btn-block btn-warning">Edit Data</button>
                        </a>
                        <a class="m-2 col-10 col-md-5 d-block" href="{{url('gudang/barang/remove',$d->id)}}">
                          <button type="button" class="btn btn-block btn-danger">Hapus Data</button>
                        </a>
                        <a class="m-2 col-10 col-md-5 d-block" href="{{url('gudang/pembelian',$d->id)}}">
