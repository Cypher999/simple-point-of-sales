  ...
  <div class="col-12">
    <div class="card overflow-auto">
      ...
      @endif
        ...
        @enderror
        <div class="row mb-2">
          <a href="{{url('admin/penjualan/add')}}" class="d-block col-5 col-sm-3 col-md-2">
          ...
          <tbody>
            @foreach($data as $d)
                <tr>
                    ...
                    <td>
                      <div class="row">
                        <a class="m-2 col-10 col-md-5 d-block" href="{{url('admin/penjualan/edit',$d->id)}}">
                          <button type="button" class="btn btn-block btn-warning">Edit Data</button>
                        </a>
                        <a class="m-2 col-10 col-md-5 d-block" href="{{url('admin/penjualan/remove',$d->id)}}">
