...
<div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <!-- /.card-header -->
      <form method="post" action="{{url('admin/profil/edit-data')}}" enctype="multipart/form-data" class="card-body">
      @if (session('success'))
...
<div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <!-- /.card-header -->
      <form method="post" action="{{url('admin/profil/edit-password')}}" enctype="multipart/form-data" class="card-body">
        @csrf
        <div class="form-group mb-3">
